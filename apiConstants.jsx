export const API_BASE_URL = 'http://10.0.0.141:5062/api';
export const ASSETS_BASE_URL = 'http://10.0.0.141:5062';
...
export const PACKAGE_ENDPOINTS = {
  GET_ALL_PACKAGES: `${API_BASE_URL}/Packages`,
  GET_PACKAGE_BY_ID: (packageId) => `${API_BASE_URL}/Packages/${packageId}`,
  CREATE_PACKAGE: `${API_BASE_URL}/Packages`,
  UPDATE_PACKAGE: (packageId) => `${API_BASE_URL}/Packages/${packageId}`,
  DELETE_PACKAGE: (packageId) => `${API_BASE_URL}/Packages/${packageId}`,
  ...
  GET_PACKAGE_MODULES: (packageId) => `${API_BASE_URL}/Packages/${packageId}/modules`,
  ASSIGN_MODULE_TO_PACKAGE: (packageId, moduleId) => `${API_BASE_URL}/Packages/${packageId}/modules/${moduleId}`,
  REMOVE_MODULE_FROM_PACKAGE: (packageId, moduleId) => `${API_BASE_URL}/Packages/${packageId}/modules/${moduleId}`,
};
