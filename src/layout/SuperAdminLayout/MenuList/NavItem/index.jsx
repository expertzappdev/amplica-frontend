...
export default function SuperAdminNavItem({ item, level, isParents = false, setSelectedID }) {
  ...
  const itemHandler = () => {
    if (downMD) handlerSuperAdminDrawerOpen(false);
  ...
  return (
    <>
      <ListItemButton
        ...
        onClick={() => itemHandler()}
      >
        <ButtonBase aria-label="super-admin-menu-icon" sx={{ borderRadius: `${borderRadius}px` }} disableRipple={drawerOpen}>
          <ListItemIcon
            sx={{
