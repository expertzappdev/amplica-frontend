...
export default function SuperAdminNavCollapse({ menu, level, parentId }) {
  ...
  const menus = menu.children?.map((item) => {
    switch (item.type) {
      case 'collapse':
        return <SuperAdminNavCollapse key={item.id} menu={item} level={level + 1} parentId={parentId} />;
      case 'item':
...
SuperAdminNavCollapse.propTypes = { 
  menu: PropTypes.any, 
